...
class MotivationSuggestionEngine {
    ...
    companion object {
        private val happySuggestions = listOf(
        ...
        private val calmSuggestions = listOf(
        ...
        private val sadSuggestions = listOf(
        ...
        private val angrySuggestions = listOf(
        ...
        private val tiredSuggestions = listOf(
        ...
        private val loveSuggestions = listOf(
        ...
        private val melancholySuggestions = listOf(
        ...
        fun getSuggestionForMood(emoji: String): String {
            return when (emoji) {
                "😊" -> happySuggestions.random()
                "😌" -> calmSuggestions.random()
                "😢" -> sadSuggestions.random()
                "😡" -> angrySuggestions.random()
                "😴" -> tiredSuggestions.random()
                "😍" -> loveSuggestions.random()
                "😔" -> melancholySuggestions.random()
                else -> happySuggestions.random() // Default fallback
            }
        }
        
        fun simulateLoadingTime(): Long {
            // Simulate realistic loading time between 1.5 and 3 seconds
